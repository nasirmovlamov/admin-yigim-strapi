// Translation data for seeding - extracted from seed-translations.js
export const translationData = [
  ...
  // Note: This is a shortened version. For production, you should import the full list
  // or use a shared data file. For now, this will seed the most critical translations.
