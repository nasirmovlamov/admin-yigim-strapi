...
export interface ApiTranslationTranslation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Manage translations for the dashboard';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    value_az: Schema.Attribute.Text;
    value_de: Schema.Attribute.Text;
    value_en: Schema.Attribute.Text;
    value_ru: Schema.Attribute.Text;
    value_tr: Schema.Attribute.Text;
  };
}
